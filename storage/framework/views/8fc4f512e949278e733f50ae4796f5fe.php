...
<html lang="id">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('Jadwal.css')); ?>" />
  </head>
  ...
  <body>
    <aside class="sidebar">
      ...
      <ul class="menu">
        <li onclick="window.location.href = '<?php echo e(url('/dashboard')); ?>'">
          <i class="fa-solid fa-table-cells-large"></i>
          Dashboard
        </li>

        <li class="active" onclick="window.location.href = '<?php echo e(url('/jadwal')); ?>'">
          <i class="fa-regular fa-calendar"></i>
          Jadwal
        </li>

        <li onclick="window.location.href = '<?php echo e(url('/dosen')); ?>'">
          <i class="fa-solid fa-users"></i>
          Dosen
        </li>

        <li onclick="window.location.href = '<?php echo e(url('/ruangan')); ?>'">
    ...
    <tr>
      ...
      <td>
        <div class="matkul-cell">
          <h4><?php echo e($jadwal->matakuliah); ?></h4>
          <span><?php echo e($jadwal->kode_jam); ?> • <?php echo e($jadwal->sks); ?> SKS</span>
        </div>
      </td>
      
      <td><?php echo e($jadwal->dosen ? $jadwal->dosen->nama : 'Dosen Tidak Ditemukan'); ?></td> 
      <td><span class="kelas-badge"> <?php echo e($jadwal->kelas); ?> </span></td>
      <td><?php echo e($jadwal->semester); ?></td>
      <td><?php echo e($jadwal->ruang); ?></td>
      <td><?php echo e($jadwal->jurusan); ?></td>
    </tr>
...
<script>
  const dbJadwals = <?php echo json_encode($jadwals, 15, 512) ?>;
  window.userRole = "<?php echo e(auth()->user()->role ?? 'guest'); ?>";
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    if (form) {
      form.addEventListener('submit', function (e) {
        ...
        fetch('<?php echo e(route("jadwal.tambah")); ?>', {
          method: 'POST',
          headers: {
...
<?php endif; ?>
<script src="<?php echo e(asset('jadwal.js')); ?>"></script>
...
</html><?php /**PATH C:\laragon\www\fikom-unika\resources\views/jadwal.blade.php ENDPATH**/ ?>