...
<html lang="id">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('dosen.css')); ?>" />
    <style>
  ...
  <body>
    <aside class="sidebar">
      ...
      <ul class="menu">
        ...
        <li class="active" onclick="window.location.href = '<?php echo e(url('/dosen')); ?>'">
    ...
    <script>
        ...
        window.dosenDariDatabase = <?php echo json_encode($dosens, 15, 512) ?>;
    ...
    <script src="<?php echo e(asset('dosen.js')); ?>"></script>
  </body>
</html><?php /**PATH C:\laragon\www\fikom-unika\resources\views/dosen.blade.php ENDPATH**/ ?>