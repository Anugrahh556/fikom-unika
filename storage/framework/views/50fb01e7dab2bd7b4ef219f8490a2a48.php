...
<html lang="id">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('ruangan.css')); ?>" />
  </head>
  <body>
    <aside class="sidebar">
      <div class="sidebar-top">
        <img src="<?php echo e(asset('Logo_UNIKA.png')); ?>" alt="Logo UNIKA" />
        <div class="logo-text">
  ...
  <li onclick="window.location.href = '<?php echo e(url('/jadwal')); ?>'">
  ...
  <li class="active" onclick="window.location.href = '<?php echo e(url('/ruangan')); ?>'">
    ...
    <script>
      ...
      window.masterJadwalServer = <?php echo json_encode($masterJadwal, 15, 512) ?>;
      window.daftarRuanganServer = <?php echo json_encode($ruangan, 15, 512) ?>;
      window.userRole = "<?php echo e(auth()->check() ? auth()->user()->role : 'guest'); ?>";
      window.daftarDosenServer = <?php echo json_encode($dosens, 15, 512) ?>;
     
      console.log("CEK DATA SERVER: ", window.masterJadwalServer);
    </script>
    
    <script src="<?php echo e(asset('ruangan.js')); ?>"></script>
  </body>
</html><?php /**PATH C:\laragon\www\fikom-unika\resources\views/ruangan.blade.php ENDPATH**/ ?>