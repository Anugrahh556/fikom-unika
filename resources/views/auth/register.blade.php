  ...
  <body>
    <div class="container">
      <div class="left-panel">
        <img class="hero-image" src="{{ asset('background.png.png') }}" alt="Ilustrasi sistem penjadwalan" />
      </div>
          ...
          <form action="{{ url('/register') }}" method="POST">
            ...
            <div class="input-group">
              ...
              <div class="input-box no-icon">
                <input type="text" name="username" placeholder="Masukkan NIDN/NIM" value="{{ old('username') }}" required autocomplete="off" />
              </div>
            </div>
